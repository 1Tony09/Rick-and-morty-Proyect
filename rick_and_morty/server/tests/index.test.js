...
describe('Test de RUTAS', () => {
    ...
    describe('POST /rickandmorty/fav', () => {
        ...
        it('Si vuelves a enviar un nuevo elemento por body, este debe ser devuelto en un arreglo que incluye un elemento', async () => {
            const response = await agent
                .post('/rickandmorty/fav')
                .send(character2);
    ...
    describe('DELETE /rickandmorty/fav/:id', () => {
        ...
        it('En el caso de que no haya ningun personaje con el ID que envias, sea un arreglo con los elementos previos sin', async () => {
        const response = await agent
